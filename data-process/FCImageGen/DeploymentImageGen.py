...
def TCI():
    ...
    Image.fromarray((tci * 255).astype('uint8'),'RGB').save(f'./Output/tci/tci.jp2')
...
def FCI(mode=1):
    ...
    Image.fromarray((fci * 255).astype('uint8'),'RGB').save(f'./Output/fci/fci-mode{mode}/fci-mode{mode}.jp2')
...
def NDVI():
    ...
    Image.fromarray((ndvi * 255).astype('uint8'),'RGB').save(f'./Output/ndvi/ndvi.jp2')
